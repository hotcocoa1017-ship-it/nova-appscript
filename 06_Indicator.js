...
function findIndicatorRoomActiveCleaningCompletions_(sheet, businessDate, site, roomNo) { // (객실 금일 활성 청소완료 이력 전체 조회)
  ...
  const columnIndex = header => Number(headerMap[header] || 0) - 1;
  const index = {
