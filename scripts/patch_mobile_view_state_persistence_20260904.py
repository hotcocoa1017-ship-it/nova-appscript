...
# 5) 업무일자/사업장 변경 시 현재 탭·필터·검색은 유지하고, 대상 범위의 저장된 동·층을 복원할 수 있게 합니다.
for label, old in [
...
# 7) 추가조회에서 점검을 시작해 TARGETS로 의도적으로 돌아간 경우에도 새 화면을 저장합니다.
