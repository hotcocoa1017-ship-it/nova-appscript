...
if MARKER not in client:
    ...
    # The same room-status sequence also appears in indicatorRoomSnapshotSignature_.
    # Anchor to roomVisualSignature_ explicitly so only the server-confirmed rerender signature changes.
